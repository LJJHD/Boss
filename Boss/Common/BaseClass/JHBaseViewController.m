...
@interface JHBaseViewController ()<UIGestureRecognizerDelegate>
...
- (void)baseSetting
{
    ...
    self.view.backgroundColor = DEF_COLOR_BACKGROUNDCOLOR;
    ...
    [self.navBar updateBackgroundColor:DEF_COLOR_NAVBAR_NORMAL];
